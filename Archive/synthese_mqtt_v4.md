...
## Document de référence pour implémentation — Version 4

**Date** : 17 mars 2026
**Statut** : Validé — Prêt pour implémentation
**Révision** : v4 — Architecture complète : VPS, PWA, stockage historique, schéma auto-publié
...
- Après la première connexion MQTT réussie
- Une seule fois par session (flag `schemaPublished`)
